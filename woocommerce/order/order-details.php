...
?>
<section class="woocommerce-order-details myaccount-vieworder">
	...
	<table class="woocommerce-table woocommerce-table--order-details shop_table order_details">
		...
		<thead>
			<tr>
				...
				<th class="woocommerce-table__product-price product-price"><?php esc_html_e( 'Unit Price', 'woocommerce' ); ?></th>
